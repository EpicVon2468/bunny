...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Core_h.C_INT.withName("__readers"),
        Core_h.C_INT.withName("__writers"),
        Core_h.C_INT.withName("__wrphase_futex"),
        Core_h.C_INT.withName("__writers_futex"),
        Core_h.C_INT.withName("__pad3"),
        Core_h.C_INT.withName("__pad4"),
        Core_h.C_INT.withName("__cur_writer"),
        Core_h.C_INT.withName("__shared"),
        Core_h.C_CHAR.withName("__rwelision"),
        MemoryLayout.sequenceLayout(7, Core_h.C_CHAR).withName("__pad1"),
        Core_h.C_LONG.withName("__pad2"),
        Core_h.C_INT.withName("__flags"),

...
public class __pthread_mutex_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Core_h.C_INT.withName("__lock"),
        Core_h.C_INT.withName("__count"),
        Core_h.C_INT.withName("__owner"),
        Core_h.C_INT.withName("__nusers"),
        Core_h.C_INT.withName("__kind"),
        Core_h.C_SHORT.withName("__spins"),
        Core_h.C_SHORT.withName("__elision"),

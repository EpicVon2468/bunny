...
fun MemScope.generatePrintInt(
	...
	val printIntFunctionType: LLVMTypeRef = LLVMFunctionType(
		...
		/*paramType =*/ allocArrayOf(int32Type),
		/*paramCount =*/ 1u,
		/*isVarArg =*/ FALSE
	)!!
	val printIntFunction: LLVMValueRef = LLVMAddFunction(module, "printInt", printIntFunctionType)!!
	functionsAndTypes.first["printInt"] = printIntFunctionType
	functionsAndTypes.second["printInt"] = printIntFunction

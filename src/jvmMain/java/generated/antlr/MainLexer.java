...
public class MainLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"LOWERCASE", "UPPERCASE", "DIGIT", "GREATER", "LESS", "EQUALS", "OPEN_PAREN", 
			"CLOSE_PAREN", "OPEN_BRACE", "CLOSE_BRACE", "ARGUMENT_SEPARATOR", "MEMBER_REFERENCE", 
			"DIV", "ADD", "SUB", "NOT", "ASTERISK", "VARARG", "ASSIGNMENT", "COMPARISON_EQUALS", 
			"COMPARISON_NOT_EQUALS", "COMPARISON_GREATER", "COMPARISON_GREATER_THAN", 
			"COMPARISON_LESS", "COMPARISON_LESS_THAN", "STRING_LITERAL", "COMMENT", 
			"DOCUMENTATION_COMMENT", "SECTION_COMMENT", "TERMINATION", "NUMBER", 
			"FUNCTION", "VARIABLE", "MUTABLE", "CONSTANT", "STRUCT", "SINGLETON", 
			"RETURN", "STATIC_KEYWORD_NEW", "STATIC_KEYWORD_INSTANCE", "STATIC_KEYWORD_DESTROY", 
			"TRUE", "FALSE", "TYPE_SPECIFIER", "VERSION", "RESERVED", "IDENTIFIER", 
			"WHITESPACE", "NEWLINE"
		};
	}
